/*globals d3,window,document,jQuery,console */
// ....................................................................
...
(function ($) {
	...
	var VisualSedimentation = function (element, options) {
		...
		//
		if (typeof (this.settings.chart.width) == "undefined") {
			this.settings.chart.width = this.settings.width;
		}
		...
		if (typeof (this.settings.stream) == "undefined") {
			this.settings.stream = {};
		}
		if (typeof (this.settings.stream.now) == "undefined") {
			this.settings.stream.now = 0;
		}
		if (typeof (this.settings.stream.provider) == "undefined") {
			this.settings.stream.provider = 'generator';
		}
		if (typeof (this.settings.stream.refresh) == "undefined") {
			this.settings.stream.refresh = 1000;
		}
		if (typeof (this.settings.data.tokenPast) == "undefined") {
			this.settings.data.tokenPast = 0;
		}
		if (typeof (this.settings.data.tokens) == "undefined") {
			this.settings.data.tokens = [];
		}
		...
		this.init = function () {
			...
			document.addEventListener("mousemove", function (e) {
				onDocumentMouseMove(e, self);
			});
			document.addEventListener("mouseup", function (e) {
				onDocumentMouseUp(e, self);
			});
			document.addEventListener("mousedown", function (e) {
				onDocumentMouseDown(e, self);
			});
		...
		var drawInit = function () {
			...
			window.setInterval(
				$.fn.vs.draw.refresh(ctx, world, this.settings), this.settings.options.refresh);
